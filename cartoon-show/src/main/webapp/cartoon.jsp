...
<body>
	...
	<div class="bg-contact3"
		style="background-image: url('https://i.ytimg.com/vi/bOt5BRxDsII/maxresdefault.jpg');">
		<div class="container-contact3">
			<div class="wrap-contact3">
				<form class="contact3-form validate-form" action = "cartoon" method="post">
					<span class="contact3-form-title"> ENTER CARTOON SHOW DETAILS </span>



					<div class="wrap-input3 validate-input"
						data-validate="Name is required">
						<input class="input3" type="text" name="cartoonName"
							placeholder="Enter Cartoon Name" required> <span
							class="focus-input3"></span>
					</div>


					<div class="wrap-input3 validate-input">
						<input class="input3" type="text" name="cartoonRatings"
							placeholder="Enter Cartoon Ratings" required> <span
							class="focus-input3"></span>
					</div>

					<div class="wrap-input3 validate-input">
						<input class="input3" type="text" name="cartoonReleaseYear"
							placeholder="Enter Cartoon Release Year" required> <span
							class="focus-input3"></span>
					</div>
