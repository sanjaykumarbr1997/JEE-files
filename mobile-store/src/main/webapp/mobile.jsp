...
<body>
	...
	<div class="bg-contact3"
		style="background-image: url('https://theindustryinsight.com/wp-content/uploads/2020/08/samsung.jpg');">
		<div class="container-contact3">
			<div class="wrap-contact3">
				<form class="contact3-form validate-form" action = "mobile" method="post">
					<span class="contact3-form-title"> ENTER MOBILE DETAILS </span>



					<div class="wrap-input3 validate-input"
						data-validate="Name is required">
						<input class="input3" type="text" name="mobileName"
							placeholder="Enter mobile Name" required> <span
							class="focus-input3"></span>
					</div>


					<div class="wrap-input3 validate-input">
						<input class="input3" type="text" name="mobileColor"
							placeholder="Enter Mobile Color" required> <span
							class="focus-input3"></span>
					</div>

					<div class="wrap-input3 validate-input">
						<input class="input3" type="text" name="mobilePrice"
							placeholder="Enter Mobile Price" required> <span
							class="focus-input3"></span>
					</div>
